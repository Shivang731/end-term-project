...
import { FiBarChart2, FiCheckCircle, FiZap } from 'react-icons/fi'

export default function Dashboard({ theme, onToggleTheme }) {
  const { tasks, loading, error, toggleTaskCompletion, removeTask } = useTaskContext()
  ...
  const stats = useMemo(() => {
    ...
    return { totalTasks, completedTasks, pendingTasks, completionPercent, globalStreak }
  }, [tasks])
  ...
  return (
    <main className={`relative min-h-screen overflow-hidden ${themeIsDark ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-950'}`}>
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/2 top-4 h-72 w-72 -translate-x-1/2 rounded-full bg-blue-500/20 blur-3xl animate-blob" />
        <div className="absolute right-0 top-24 h-56 w-56 rounded-full bg-slate-500/20 blur-3xl" />
        ...
        >
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-white">Built for weekly focus with premium polish.</h2>
              <p className="mt-2 max-w-2xl text-sm text-slate-400">
                Persistent tasks per account, progress updates, streak tracking, and polished micro-interactions.
              </p>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3">
              <div className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
                ...
                <div className="mt-3 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-semibold text-white">{stats.completionPercent}%</p>
              ...
              <div className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
                ...
                <div className="mt-3 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-semibold text-white">{stats.globalStreak}d</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <h2 className="mt-4 text-3xl font-bold text-white">{stats.totalTasks}</h2>
              </motion.div>
              ...
              >
                ...
                <h2 className="mt-4 text-3xl font-bold text-white">{stats.completedTasks}</h2>
              </motion.div>
              ...
              >
                ...
                <h2 className="mt-4 text-3xl font-bold text-white">{stats.pendingTasks}</h2>
              </motion.div>
            </div>
            ...
            >
              ...
              {error && (
                <div className="mt-6 rounded-3xl border border-rose-500/20 bg-rose-500/10 p-5 text-rose-200">
                  <p className="text-sm uppercase tracking-[0.24em] text-rose-200/80">Error</p>
              ...
              {loading && (
                <div className="mt-8 rounded-3xl border border-white/10 bg-slate-950/40 p-8 text-slate-300">
                  Syncing tasks from the cloud…
                </div>
              )}
